    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-two-anonymized-workshop-submissions-are-under-review-iclr-2026-workshop-track",
          title: 'Two anonymized workshop submissions are under review (ICLR 2026 workshop track).',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=Yb4f6vUAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
